...
class random_forest(object):
    ...
    def target_train(self):
        ...
        for i in trange(self.confs['sample_params']['sample_epoch']):
            ...
            every_epoch_remain_sample_num.append(len(condenseed_sample_data))
            every_epoch_remain_sample_ratio.append(len(condenseed_sample_data)/len(sample_data))
            ...
            temp_data.to_csv(self.save_filesname+"temp.csv", index=False)
