...
class random_forest(object):
    ...
    def target_train(self):
        ...
        for i in trange(self.confs['sample_params']['sample_epoch']):
            ...
            # 提取原任务分类器
            self.sourcetask_svm_classifier=self.get_sourcetask_svm_clf("./classifier/svm/")

            # 选择原任务
            self.selected_svm_classifier=self.choose_source(self.slected_k_source,self.similarity_list,self.sourcetask_svm_classifier)
